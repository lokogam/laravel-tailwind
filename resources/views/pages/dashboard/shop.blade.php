        ...
        <div>
            ...
            <div class="mt-8">
                ...
                <div class="grid grid-cols-12 gap-6">
                    <x-dashboard.shop.shop-cards-01/>
                </div>
            </div>
            ...
            <div class="mt-8">
                ...
                <div class="grid grid-cols-12 gap-6">
                    <x-dashboard.shop.shop-cards-02/>
                </div>
            </div>
            ...
            <div class="mt-8">
                ...
                <div class="grid grid-cols-12 gap-6">
                    <x-dashboard.shop.shop-cards-03/>
                </div>
            </div>
            ...
            <div class="mt-8">
                ...
                <div class="grid grid-cols-12 gap-6">
                    <x-dashboard.shop.shop-cards-04/>
                </div>
            </div>
            ...
            <div class="mt-8">
                ...
                <div class="grid grid-cols-12 gap-6">
                    <x-dashboard.shop.shop-cards-05/>
                </div>
            </div>
            ...
            <div class="mt-8">
                ...
                <div class="grid grid-cols-12 gap-6">
                    <x-dashboard.shop.shop-cards-06/>
                </div>
            </div>
