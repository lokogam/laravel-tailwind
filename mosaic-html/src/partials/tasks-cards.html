...
<div class="col-span-full sm:col-span-6 xl:col-span-3">
    ...
    <header>
        <div class="flex items-center justify-between mb-2">
            <h2 class="grow font-semibold text-gray-800 truncate">To Do’s 🖋️</h2>
        ...
        <div class="grid gap-2">
            ...
            <div class="bg-white shadow-lg rounded-sm border border-gray-200 p-4">
                ...
                <div class="mb-3">
                    <!-- Title -->
                    <h2 class="font-semibold text-gray-800 mb-1">User should receive a daily digest email</h2>
                    <!-- Content -->
                    <div>
                ...
                <div class="flex items-center justify-between">
                    <!-- Left side -->
                    <button class="p-2 shrink-0 rounded-full bg-white border border-gray-200 hover:border-gray-300 text-indigo-500 transition duration-150">
            ...
            <div class="bg-white shadow-lg rounded-sm border border-gray-200 p-4">
                ...
                <div class="mb-3">
                    <!-- Title -->
                    <h2 class="font-semibold text-gray-800 mb-1">Change license and remove references to products</h2>
                </div>
                <!-- Footer -->
                <div class="flex items-center justify-between">
                    <!-- Left side -->
...
<div class="col-span-full sm:col-span-6 xl:col-span-3">
    ...
    <header>
        <div class="flex items-center justify-between mb-2">
            <h2 class="grow font-semibold text-gray-800 truncate">In Progress ✌️</h2>
            <button class="shrink-0 text-indigo-500 hover:text-indigo-600 ml-2">
                <svg class="w-4 h-4 fill-current" viewBox="0 0 16 16">
                    <path d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z" />
                </svg>
...
<div class="col-span-full sm:col-span-6 xl:col-span-3">
    ...
    <header>
        <div class="flex items-center justify-between mb-2">
            <h2 class="grow font-semibold text-gray-800 truncate">Completed 🎉</h2>
            <button class="shrink-0 text-indigo-500 hover:text-indigo-600 ml-2">
                <svg class="w-4 h-4 fill-current" viewBox="0 0 16 16">
                    <path d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z" />
                </svg>
        ...
        <div class="grid gap-2">
            ...
            <div class="bg-white shadow-lg rounded-sm border border-gray-200 p-4">
                ...
                <div class="mb-3">
                    <!-- Title -->
                    <h2 class="font-semibold text-gray-800 mb-1">Design new diagrams</h2>
                    <!-- Content -->
                    <div>
            ...
            <div class="bg-white shadow-lg rounded-sm border border-gray-200 p-4">
                ...
                <div class="mb-3">
                    <!-- Title -->
                    <h2 class="font-semibold text-gray-800 mb-1">Manage internal feedback</h2>
                </div>
                <!-- Meta -->
                <div class="flex items-center justify-between">
                    <!-- Left side -->
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="flex items-center text-gray-400 ml-3">
                            ...
                            <div class="text-sm text-gray-500">2/2</div>
                        </div>
                        <!-- Attach button -->
                        <button class="text-gray-400 hover:text-indigo-500 ml-3">
                            <svg class="w-4 h-4 shrink-0 fill-current mr-1.5" viewBox="0 0 16 16">
                ...
                <ul class="mt-3">
                    <li class="flex items-center border-t border-gray-200 py-2">
                        ...
                        <div class="text-sm text-gray-400 line-through">Call with incoming clients</div>
                    </li>
                    <li class="flex items-center border-t border-gray-200 py-2">
                        <svg class="w-3 h-3 shrink-0 fill-current text-green-500 mr-2" viewBox="0 0 12 12">
                            <path d="M10.28 1.28L3.989 7.575 1.695 5.28A1 1 0 00.28 6.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 1.28z" />
                        </svg>
                        <div class="text-sm text-gray-400 line-through">Manage inbound deals</div>
                    </li>
                </ul>
            </div>
...
<div class="col-span-full sm:col-span-6 xl:col-span-3">
    ...
    <header>
        <div class="flex items-center justify-between mb-2">
            <h2 class="grow font-semibold text-gray-800 truncate">Notes 📒</h2>
            <button class="shrink-0 text-indigo-500 hover:text-indigo-600 ml-2">
                <svg class="w-4 h-4 fill-current" viewBox="0 0 16 16">
                    <path d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z" />
                </svg>
