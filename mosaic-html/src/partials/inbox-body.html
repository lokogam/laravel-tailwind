        ...
        <div class="bg-white shadow-lg rounded-sm border border-gray-200 px-6 divide-y divide-gray-200">
            ...
            <div class="py-6" x-data="{ open: false }">
                ...
                <header class="flex items-start">
                    <!-- Avatar -->
                    <img class="rounded-full shrink-0 mr-3" src="../images/user-40-11.jpg" width="40" height="40" alt="User 11" />
                    <!-- Meta -->
                    <div class="grow">
                        <div class="sm:flex items-start justify-between mb-0.5">
                            <!-- Message author -->
                            <div class="xl:flex items-center mb-2 sm:mb-0">
                                <button class="text-sm font-semibold text-gray-800 text-left truncate" @click.prevent="open = !open">Dominik Lamakani</button>
                                <div class="text-sm text-gray-400 hidden xl:block mx-1" x-show="open" x-cloak>·</div>
                ...
                <!-- Body -->
                <div class="text-sm text-gray-800 mt-4 space-y-2" x-show="open" x-cloak>
            ...
            <div class="py-6" x-data="{ open: false }">
                ...
                <header class="flex items-start">
                    <!-- Avatar -->
                    <img class="rounded-full shrink-0 mr-3" src="../images/user-avatar-80.png" width="40" height="40" alt="User 11" />
                    <!-- Meta -->
                    <div class="grow">
                        <div class="sm:flex items-start justify-between mb-0.5">
                            <!-- Message author -->
                            <div class="xl:flex items-center mb-2 sm:mb-0">
                                <button class="text-sm font-semibold text-gray-800 text-left truncate" @click.prevent="open = !open">Acme Inc.</button>
                                <div class="text-sm text-gray-400 hidden xl:block mx-1" x-show="open" x-cloak>·</div>
            ...
            <div class="py-6" x-data="{ open: true }">
                ...
                <div class="text-sm text-gray-800 mt-4 space-y-2" x-show="open" x-cloak>
                    ...
                    <p>
                        <img src="../images/inbox-image.jpg" width="320" height="190" alt="Inbox image" />
                    </p>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                    <p>Cheers,</p>
                    <p class="font-medium">Dominik Lamakani</p>
