...
>
            ...
            <div class="flex items-center">
                ...
                <div class="flex -space-x-3 -ml-px">
                    <a class="block" href="#0">
                        <img class="rounded-full border-2 border-white box-content" src="../images/user-32-01.jpg" width="32" height="32" alt="User 01" />
                    </a>
                    <a class="block" href="#0">
    ...
    <div class="grow px-4 sm:px-6 md:px-5 py-6">
        ...
        <div class="flex items-start mb-4 last:mb-0">
            ...
            <div>
                <div class="flex items-center">
                    <img class="rounded-lg shadow-md mb-1" src="../images/chat-image.jpg" width="240" height="180" alt="Chat image" />
                    <button class="p-1.5 rounded-full border border-gray-200 ml-4 hover:bg-white transition duration-150">
                        <span class="sr-only">Download</span>
                        <svg class="w-4 h-4 shrink-0 fill-current text-gray-400"  viewBox="0 0 16 16">
        ...
        <div class="flex justify-center">
            <div class="inline-flex items-center justify-center text-xs font-medium px-2.5 py-1 bg-white border border-gray-200 rounded-full my-5">
                Tuesday, 20 January
            </div>
        </div>
        <!-- Chat msg -->
