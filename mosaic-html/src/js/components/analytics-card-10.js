      ...
      datasets: [
        {
          ...
          backgroundColor: [
            ...
            `rgba(${hexToRGB(fullConfig.theme.colors['light-blue'][400])}, 0.8)`,
            `rgba(${hexToRGB(fullConfig.theme.colors.green[500])}, 0.8)`,
          ],
          hoverBackgroundColor: [
            `rgba(${hexToRGB(fullConfig.theme.colors.indigo[600])}, 0.8)`,
            `rgba(${hexToRGB(fullConfig.theme.colors['light-blue'][500])}, 0.8)`,
            `rgba(${hexToRGB(fullConfig.theme.colors.green[600])}, 0.8)`,
          ],
